...
#define STRING_CONFIG_H_AUTHOR "Richard Schmidt, CR-10 V3)" // Who made the changes. RGS- MINE!
 ...
 */
#define BAUDRATE 115200 //RGS 250000 to 115200
 ...
 *
 */
#define TEMP_SENSOR_0 5 //RGS Changed from 1 to match Hemera Thermistor
...
#define HEATER_0_MAXTEMP 285 //RGS 285 from 275 to match Hemera Stock Spec
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.34  //RGS Values found via PID Cycles in Repetier Host
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.00, 80.00, 400.00, 390 }  

                                                                //RGS*  Initially last figure from 407 to 409 per Hemera Marlin Guide
                                                                //      E-Steps mesurement 105 of 100 expected@ 409.
                                                                //      100/105*409 = 389.52 for final esteps value.
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //RGS Uncommented this line
...
#define Z_STOP_PIN 19 //RGS Make z stop into BL touch.
...
#define INVERT_E0_DIR false //RGS Flipped back as Hemera is reversed.
